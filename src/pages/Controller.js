...
export const Modifier_Articles = async (article,id) => {
   const res = await axios.patch(`http://localhost:5000/Articles/${id}`, article);
    return res.data;
}
...
export const Modifier_Magasins = async (Magasin,id) => {
   const res = await axios.patch(`http://localhost:5000/Magasins/${id}`, Magasin);
    return res.data;
}
...
export const Ajouter_Fournisseurs = async (fournisseur) => {
    const res = await axios.post(`http://localhost:5000/Fournisseurs`, fournisseur); 
    return res.data;
}
// ==================== [Modifier Fournisseur] ============================
export const Modifier_Fournisseurs = async (fournisseur,id) => {
   const res = await axios.patch(`http://localhost:5000/Fournisseurs/${id}`, fournisseur);
    return res.data;
}
...
export const Modifier_Commandes = async (commande,id) => {
   const res = await axios.patch(`http://localhost:5000/Commandes/${id}`, commande);
    return res.data;
}
