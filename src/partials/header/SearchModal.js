...
import Fournisseurs from './../Datatable/FournisseurTable';
function SearchModal() {
  ...
  return (
    <div>
      ...
      <button
        ref={trigger}
        className={`w-8 h-8 flex items-center justify-center transition duration-150 rounded-full ml-3 ${searchOpen && 'bg-gray-200'}`}
        ...
        <div className="bg-white overflow-auto max-w-2xl w-full max-h-full rounded shadow-lg" ref={searchContent}>
          ...
          <div className="py-4 px-2" onFocus={() => setSearchOpen(true)} onBlur={() => setSearchOpen(false)}>
            ...
            <div className="mb-3 last:mb-0">
              <div className="text-xs font-semibold text-gray-400 uppercase px-2 mb-2">Recherches récentes</div>
            ...
            {/* Recent pages */}
            <div className="mb-3 last:mb-0">
              <div className="text-xs font-semibold text-gray-400 uppercase px-2 mb-2">Pages récentes</div>
            </div>
          </div>
        </div>
      </Transition>
